...
public class indcheThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indche_three);
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myref = firebaseDatabase.getReference().child("INDCHETHREE");
    ...
    public void getusers(){
        ...
        DatabaseReference myref = fd.getReference().child("INDCHETHREE");
    ...
    private void fetchData(DataSnapshot dataSnapshot)
    {
        ...
        DATAAdapter adapter = new DATAAdapter(indcheThree.this,user);
