...
public class mltThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mlt_three);
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myref = firebaseDatabase.getReference().child("MLTTHREE");
    ...
    public void getusers(){
        ...
        DatabaseReference myref = fd.getReference().child("MLTTHREE");
    ...
    private void fetchData(DataSnapshot dataSnapshot)
    {
        ...
        DATAAdapter adapter = new DATAAdapter(mltThree.this,user);
