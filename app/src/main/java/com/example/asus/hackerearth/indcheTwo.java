...
public class indcheTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indche_two);
    ...
    public void getusers(){
        ...
        DatabaseReference myref = fd.getReference().child("INDCHETWO");
    ...
    private void fetchData(DataSnapshot dataSnapshot)
    {
        ...
        DATAAdapter adapter = new DATAAdapter(indcheTwo.this,user);
