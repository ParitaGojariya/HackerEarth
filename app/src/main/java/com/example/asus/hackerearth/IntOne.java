...
public class IntOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_int_one);
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myref = firebaseDatabase.getReference().child("INTONE");
    ...
    public void getusers(){
        ...
        DatabaseReference myref = fd.getReference().child("INTONE");
    ...
    private void fetchData(DataSnapshot dataSnapshot)
    {
        ...
        DATAAdapter adapter = new DATAAdapter(IntOne.this,user);
