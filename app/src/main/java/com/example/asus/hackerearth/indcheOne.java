...
public class indcheOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indche_one);
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myref = firebaseDatabase.getReference().child("INDCHEONE");
    ...
    public void getusers(){
        ...
        DatabaseReference myref = fd.getReference().child("INDCHEONE");
    ...
    private void fetchData(DataSnapshot dataSnapshot)
    {
        ...
        DATAAdapter adapter = new DATAAdapter(indcheOne.this,user);
