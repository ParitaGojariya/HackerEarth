...
public class mbaThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mba_three);
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myref = firebaseDatabase.getReference().child("MBATHREE");
    ...
    public void getusers(){
        ...
        DatabaseReference myref = fd.getReference().child("MBATHREE");
    ...
    private void fetchData(DataSnapshot dataSnapshot)
    {
        ...
        DATAAdapter adapter = new DATAAdapter(mbaThree.this,user);
